...
# -----------------------------------------------------------------------------
# Cas nominaux : entrees valides et representatives
# -----------------------------------------------------------------------------
...
def test_predict_nominal_cases(features, expected):
    """La fonction doit retourner une prédiction conforme Ã  la règle y = 2x."""
...
def test_predict_boundary_cases(features, expected):
    """La fonction doit gÃ©rer correctement les valeurs limites ou particulières."""
    result = predict(features)
...
def test_predict_empty_list_raises_exception():
    """
    Une liste vide ne contient aucun Échantillon Ã  prédire.
...
def test_predict_invalid_inputs_raise_exception(invalid_features):
    """La fonction doit Échouer de manière contrÃ´lÃ©e avec des entrées invalides."""
...
# -----------------------------------------------------------------------------
# CAS EXCEPTIONNEL Entrée sous forme de liste mais inexploitable
# -----------------------------------------------------------------------------
